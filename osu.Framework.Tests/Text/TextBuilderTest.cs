...
namespace osu.Framework.Tests.Text
{
    ...
    public class TextBuilderTest
    {
        ...
        /// <summary>
        /// Tests that a character with a greater baseline moves the previous character down to align.
        /// </summary>
        [Test]
        public void TestCharacterWithGreaterBaselineOffsetsPreviousCharacters()
        {
            var builder = new TextBuilder(fontStore, normal_font);
        ...
        /// <summary>
        /// Tests that a character with a lower baseline gets moved down to align with the previous characters.
        /// </summary>
        [Test]
        public void TestCharacterWithLowerBaselineGetsOffset()
        {
            var builder = new TextBuilder(fontStore, normal_font);
