...
namespace osu.Framework.Graphics.Veldrid
{
    public static partial class Vd
    {
        ...
        /// </summary>
        /// <param name="veldridTexture">The texture to bind.</param>
        /// <param name="wrapModeS">The texture wrap mode in horizontal direction.</param>
        /// <param name="wrapModeT">The texture wrap mode in vertical direction.</param>
        /// <returns>true if the provided texture was not already bound (causing a binding change).</returns>
        public static bool BindTexture(VeldridTexture veldridTexture, WrapMode wrapModeS = WrapMode.None, WrapMode wrapModeT = WrapMode.None)
        {
            bool didBind = BindTexture(veldridTexture?.TextureResourceSet, wrapModeS, wrapModeT);
            AtlasTextureIsBound = veldridTexture is VeldridTextureAtlas;
