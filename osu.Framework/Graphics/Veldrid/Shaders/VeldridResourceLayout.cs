...
{
    /// <summary>
    /// Describes the layout of a resource set in a Veldrid shader.
    /// </summary>
    internal class VeldridResourceLayout : IDisposable
    {
        ...
        public VeldridResourceLayout(int set, ResourceLayout layout)
        {
            Set = set;
            Layout = layout;
        }
