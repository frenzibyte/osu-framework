...
{
    public abstract class VeldridTexture : IDisposable
    {
        /// <summary>
        ...
        protected VeldridTexture(WrapMode wrapModeS = WrapMode.None, WrapMode wrapModeT = WrapMode.None)
        {
            WrapModeS = wrapModeS;
            WrapModeT = wrapModeT;
        }
        ...
        /// <summary>
        /// Whether this <see cref="VeldridTexture"/> can used for drawing.
        /// </summary>
        ...
        public abstract VeldridTexture Native { get; }
        ...
        /// <summary>
        /// Sets the pixel data of this <see cref="VeldridTexture"/>.
        /// </summary>
        ...
        /// <summary>
        /// Sets the pixel data of this <see cref="VeldridTextureAtlas"/>.
        /// </summary>
        /// <param name="upload">The <see cref="ITextureUpload"/> containing the data.</param>
        /// <param name="wrapModeS">The texture wrap mode in horizontal direction.</param>
        /// <param name="wrapModeT">The texture wrap mode in vertical direction.</param>
