...
namespace osu.Framework.Graphics.Veldrid.Textures
{
    ...
    /// </summary>
    internal class VeldridTextureAtlas : VeldridTextureSingle
    {
        /// <summary>
        ...
        public VeldridTextureAtlas(int width, int height, bool manualMipmaps, FilteringMode filteringMode = FilteringMode.Linear, int padding = 0)
