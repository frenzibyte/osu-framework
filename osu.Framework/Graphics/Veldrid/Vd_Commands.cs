...
namespace osu.Framework.Graphics.Veldrid
{
    public static partial class Vd
    {
        ...
        /// </summary>
        /// <param name="commands">The command list to send commands to.</param>
        /// <returns>An <see cref="InvokeOnDisposal"/> to be used in a <see langword="using"/> statement.</returns>
        ...
        public static void DrawPrimitives(PrimitiveTopology topology, int indexStart, int indicesCount)
        {
