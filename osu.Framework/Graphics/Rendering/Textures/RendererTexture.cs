...
{
    public abstract class RendererTexture : IDisposable
    {
        /// <summary>
        ...
        protected RendererTexture(WrapMode wrapModeS = WrapMode.None, WrapMode wrapModeT = WrapMode.None)
        {
            WrapModeS = wrapModeS;
            WrapModeT = wrapModeT;
        }
        ...
        /// <summary>
        /// Whether this <see cref="RendererTexture"/> can used for drawing.
        /// </summary>
        ...
        public abstract RendererTexture Native { get; }
        ...
        internal abstract void DrawTriangle(IRenderer renderer, Triangle vertexTriangle, ColourInfo drawColour, RectangleF? textureRect = null, Action<TexturedVertex2D> vertexAction = null,
        ...
        internal abstract void DrawQuad(IRenderer renderer, Quad vertexQuad, ColourInfo drawColour, RectangleF? textureRect = null, Action<TexturedVertex2D> vertexAction = null,
        ...
        /// <summary>
        /// Sets the pixel data of this <see cref="RendererTexture"/>.
        /// </summary>
        ...
        /// <summary>
        /// Sets the pixel data of this <see cref="RendererTextureAtlas"/>.
        /// </summary>
        /// <param name="upload">The <see cref="ITextureUpload"/> containing the data.</param>
        /// <param name="wrapModeS">The texture wrap mode in horizontal direction.</param>
        /// <param name="wrapModeT">The texture wrap mode in vertical direction.</param>
