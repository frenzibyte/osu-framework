...
{
    internal class RendererTextureSub : RendererTexture
    {
        private readonly RendererTexture parent;
        ...
        public RendererTextureSub(RectangleI bounds, RendererTexture parent, WrapMode wrapModeS = WrapMode.None, WrapMode wrapModeT = WrapMode.None)
            : base(wrapModeS, wrapModeT)
        {
            ...
            if (Renderer.IsInitialized && parent == null)
