...
vec4 wrappedTexture(vec2 wrappedCoord, vec4 texRect, texture2D wrapTexture, sampler wrapSampler)
{
    ...
    return texture(sampler2D(wrapTexture, wrapSampler), wrappedCoord);
}
