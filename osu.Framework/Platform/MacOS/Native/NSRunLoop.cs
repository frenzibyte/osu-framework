...
namespace osu.Framework.Platform.MacOS.Native
{
    internal readonly struct NSRunLoop
    {
        ...
        private static readonly IntPtr sel_run_mode = Selector.Get("runMode:beforeDate:");
        ...
        public bool Run(NSRunLoopMode mode, NSDate limitDate)
            => Cocoa.SendBool(Handle, sel_run_mode, mode.Handle, limitDate.Handle);
    }
}
