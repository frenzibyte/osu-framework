...
namespace osu.Framework.Platform
{
    ...
    public class SDL2DesktopWindow : IWindow
    {
        ...
        public void SetupWindow(FrameworkConfigManager config)
        {
            ...
            sizeWindowed.MinValueChanged += min => ScheduleCommand(() => SDL.SDL_SetWindowMinimumSize(SDLWindowHandle, min.Width, min.Height));
            sizeWindowed.MaxValueChanged += max => ScheduleCommand(() => SDL.SDL_SetWindowMaximumSize(SDLWindowHandle, max.Width, max.Height));
