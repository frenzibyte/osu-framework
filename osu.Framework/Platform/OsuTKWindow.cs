...
namespace osu.Framework.Platform
{
    public abstract class OsuTKWindow : IWindow, IGameWindow
    {
        ...
        protected internal readonly IGameWindow OsuTKGameWindow;

        private readonly OsuTKGraphicsBackend graphicsBackend;
        ...
        protected OsuTKWindow([NotNull] IGameWindow osuTKGameWindow)
        {
            ...
            graphicsBackend = new OsuTKGraphicsBackend();
        ...
        public IntPtr DisplayHandle => throw new InvalidOperationException($"{DisplayHandle} is not supported.");
